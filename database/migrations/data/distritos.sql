...
-- Dumping structure for table select_db.distritos
# CREATE TABLE IF NOT EXISTS `distritos` (
#   `id` mediumint(8) unsigned NOT NULL COMMENT 'código de distrito, 5 dígitos: 1 de provincia, 2 de cantón y 2 de distrito ',
#   `canton_id` smallint(5) unsigned NOT NULL,
#   `distrito_nombre` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
#   PRIMARY KEY (`id`),
#   KEY `distritos_canton_id_foreign` (`canton_id`),
#   CONSTRAINT `distritos_canton_id_foreign` FOREIGN KEY (`canton_id`) REFERENCES `cantones` (`id`)
